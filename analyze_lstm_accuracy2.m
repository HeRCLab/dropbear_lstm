...
% subsample for ensemble
[x_sub2,signal_sub2] = myresample(signal,sample_rate,sample_rate/2);
[x_sub4,signal_sub4] = myresample(signal,sample_rate,sample_rate/4);
[x_sub8,signal_sub8] = myresample(signal,sample_rate,sample_rate/8);
