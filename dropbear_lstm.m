...
downsample_levels = 8:8:60; % relative to input sample rate
history_lengths = 1:10;     % relative to 25 samples at input sample rate
...
% set up results grid
[xg,yg]=meshgrid(input_sample_rate./downsample_levels,history_lengths.*25./input_sample_rate);
